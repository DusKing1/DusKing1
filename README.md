...
- [NeutronRC/betaflight-presets](https://github.com/NeutronRC/betaflight-presets) -  (4 weeks ago)
...
- [gyroflow/gyroflow](https://github.com/gyroflow/gyroflow) ([v1.0.1](https://github.com/gyroflow/gyroflow/releases/tag/v1.0.1), today) - Video stabilization using gyroscope data
...
- [yunswj/STM32-HDMI-CEC](https://github.com/yunswj/STM32-HDMI-CEC) - (｡･∀･)ﾉﾞ嗨，需要一个廉价的CEC方案不 (4 days ago)
