...
- [BossHobby/QUICKSILVER](https://github.com/BossHobby/QUICKSILVER) ([v0.10.2](https://github.com/BossHobby/QUICKSILVER/releases/tag/v0.10.2), 3 weeks ago) - Flight Controller Firmware
- [iNavFlight/inav](https://github.com/iNavFlight/inav) ([7.0.0](https://github.com/iNavFlight/inav/releases/tag/7.0.0), 4 weeks ago) - INAV: Navigation-enabled flight control software
...
- [Quick-Flash/QuickDrehm](https://github.com/Quick-Flash/QuickDrehm) - Teensy DIY flight controller and stabilization (3 weeks ago)
- [gyroflow/gyroflow-adobe](https://github.com/gyroflow/gyroflow-adobe) - Gyroflow plugin for Adobe Premiere and After Effects (3 weeks ago)
...
- [Frogrey/MIMXRT1170EVKB-VGLite-RTThreadNano](https://github.com/Frogrey/MIMXRT1170EVKB-VGLite-RTThreadNano) - VGLite examples from RT1170 EVKB SDK, in which FreeRTOS is replaced with RT-Thread Nano. (3 months ago)
- [RayWangQvQ/BiliBiliToolPro](https://github.com/RayWangQvQ/BiliBiliToolPro) - B 站（bilibili）自动任务工具，支持docker、青龙、k8s等多种部署方式。敏感肌也能用。 (5 months ago)
