...
- [flightng/firmware](https://github.com/flightng/firmware) ([v0.2.0-rc2](https://github.com/flightng/firmware/releases/tag/v0.2.0-rc2), 1 day ago) - 
...
- [Sync Fidelity X docs with firmware v0.2.0 and configurator](https://github.com/flightng/docs/pull/18) on [flightng/docs](https://github.com/flightng/docs) (2 days ago)
...
- [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) - Pre-indexed code knowledge graph, auto syncs on code changes, for Claude Code, Codex, Gemini, Cursor, OpenCode, AntiGravity, Kiro, and Hermes Agent — fewer tokens, fewer tool calls, 100% local (4 weeks ago)
