...
- [iNavFlight/inav](https://github.com/iNavFlight/inav) ([9.0.0-RC2](https://github.com/iNavFlight/inav/releases/tag/9.0.0-RC2), 1 week ago) - INAV: Navigation-enabled flight control software
...
- [CallMeR/opnsense_configuration_notes](https://github.com/CallMeR/opnsense_configuration_notes) - OPNsense 防火墙的安装以及折腾手记。 (1 day ago)
...
- [MoonshotAI/kosong](https://github.com/MoonshotAI/kosong) - The LLM abstraction layer for modern AI agent applications. (4 weeks ago)
