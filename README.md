...
- [Add missing MIT license](https://github.com/gyroflow/flowshutter/pull/62) on [gyroflow/flowshutter](https://github.com/gyroflow/flowshutter) (1 day ago)
- [Add some OTA options and settings](https://github.com/gyroflow/flowshutter/pull/61) on [gyroflow/flowshutter](https://github.com/gyroflow/flowshutter) (1 day ago)
- [Add basic wlan scanning](https://github.com/gyroflow/flowshutter/pull/60) on [gyroflow/flowshutter](https://github.com/gyroflow/flowshutter) (2 days ago)
- [Fix rec_battery causes lockup](https://github.com/gyroflow/flowshutter/pull/59) on [gyroflow/flowshutter](https://github.com/gyroflow/flowshutter) (3 days ago)
- [Imporve audio injection](https://github.com/gyroflow/flowshutter/pull/58) on [gyroflow/flowshutter](https://github.com/gyroflow/flowshutter) (4 days ago)
- [Add basic audio injection](https://github.com/gyroflow/flowshutter/pull/57) on [gyroflow/flowshutter](https://github.com/gyroflow/flowshutter) (5 days ago)
- [Update Wuxi warning](https://github.com/gyroflow/flowshutter/pull/56) on [gyroflow/flowshutter](https://github.com/gyroflow/flowshutter) (5 days ago)
- [Typofix and author update](https://github.com/gyroflow/logger-presets/pull/3) on [gyroflow/logger-presets](https://github.com/gyroflow/logger-presets) (5 days ago)
- [Update runaway takeoff prevention to OFF](https://github.com/gyroflow/logger-presets/pull/2) on [gyroflow/logger-presets](https://github.com/gyroflow/logger-presets) (5 days ago)
- [Allow to check battery during recording](https://github.com/gyroflow/flowshutter/pull/55) on [gyroflow/flowshutter](https://github.com/gyroflow/flowshutter) (5 days ago)
...
- [mkomon/uota](https://github.com/mkomon/uota) - Update firmware written in MicroPython over the air. (3 days ago)
- [lvgl/lv_micropython](https://github.com/lvgl/lv_micropython) - Micropython bindings to LVGL for Embedded devices, Unix and JavaScript (5 days ago)
