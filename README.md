...
- [iNavFlight/inav](https://github.com/iNavFlight/inav) ([9.0.0](https://github.com/iNavFlight/inav/releases/tag/9.0.0), 1 day ago) - INAV: Navigation-enabled flight control software
...
- [Improve responsive typography and fullpage scroll](https://github.com/flightng/docs/pull/11) on [flightng/docs](https://github.com/flightng/docs) (5 days ago)
- [Revise and expand Fidelity X documentation](https://github.com/flightng/docs/pull/9) on [flightng/docs](https://github.com/flightng/docs) (6 days ago)
...
- [POSO-PocketSolutions/opencode-cursor-auth](https://github.com/POSO-PocketSolutions/opencode-cursor-auth) - Zero-config authentication for Cursor tools using local credentials. (3 days ago)
