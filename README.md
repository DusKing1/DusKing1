...
- [iNavFlight/inav](https://github.com/iNavFlight/inav) ([8.0.0-RC4](https://github.com/iNavFlight/inav/releases/tag/8.0.0-RC4), 5 days ago) - INAV: Navigation-enabled flight control software
...
- [nofeletru/UsbAsp-flash](https://github.com/nofeletru/UsbAsp-flash) - Program allow you to program flash memory on the protocols spi, I2C, MicroWire. Supports CH341a, CH347, UsbAsp, AVRISP(LUFA), Arduino, FT232H. (1 day ago)
