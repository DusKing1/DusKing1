...
- [DusKing1/KISS-GUI-CN](https://github.com/DusKing1/KISS-GUI-CN) - Chinese (Both Simplified and Traditional ) Translation for KISS configurator (4 months ago)
- [AlkaMotors/F051_Bootloader_Updater](https://github.com/AlkaMotors/F051_Bootloader_Updater) -  (5 months ago)
- [betaflight/blackbox-log-viewer](https://github.com/betaflight/blackbox-log-viewer) - Interactive log viewer for flight logs recorded with blackbox (6 months ago)
...
- [stylesuxx/esc-configurator](https://github.com/stylesuxx/esc-configurator) ([v0.18.0](https://github.com/stylesuxx/esc-configurator/releases/tag/v0.18.0), 2 weeks ago) - A Web-App to flash your ESC&#39;s from the browser using the Web-Serial API.
...
- [Update azure used fixed ubuntu version](https://github.com/betaflight/betaflight-configurator/pull/2576) on [betaflight/betaflight-configurator](https://github.com/betaflight/betaflight-configurator) (1 day ago)
- [Remove outdated dashboard setting in HYBRIDG4 target](https://github.com/betaflight/unified-targets/pull/498) on [betaflight/unified-targets](https://github.com/betaflight/unified-targets) (3 days ago)
...
- [typofix](https://github.com/DusKing1/PID-Evaluator/pull/9) on [DusKing1/PID-Evaluator](https://github.com/DusKing1/PID-Evaluator) (1 week ago)
- [Add spelling check CI](https://github.com/DusKing1/PID-Evaluator/pull/8) on [DusKing1/PID-Evaluator](https://github.com/DusKing1/PID-Evaluator) (1 week ago)
- [Add AM32 identifier](https://github.com/AlkaMotors/AM32-MultiRotor-ESC-firmware/pull/53) on [AlkaMotors/AM32-MultiRotor-ESC-firmware](https://github.com/AlkaMotors/AM32-MultiRotor-ESC-firmware) (3 weeks ago)
- [fix wrong type in ID for NERC](https://github.com/betaflight/unified-targets/pull/479) on [betaflight/unified-targets](https://github.com/betaflight/unified-targets) (4 weeks ago)
- [Add delay](https://github.com/DusKing1/PID-Evaluator/pull/7) on [DusKing1/PID-Evaluator](https://github.com/DusKing1/PID-Evaluator) (4 weeks ago)

#### ⭐ Recent Stars

- [EdgeTX/edgetx](https://github.com/EdgeTX/edgetx) - EdgeTX is the cutting edge of OpenTx (6 days ago)
- [pascallanger/DIY-Multiprotocol-TX-Module](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module) - Multiprotocol TX Module (or MULTI-Module) is a 2.4GHz transmitter module which controls many different receivers and models. (6 days ago)
- [freqtrade/freqtrade](https://github.com/freqtrade/freqtrade) - Free, open source crypto trading bot (6 days ago)
- [seldridge/verilog](https://github.com/seldridge/verilog) - Repository for basic (and not so basic) Verilog blocks with high re-use potential (4 weeks ago)
- [zhongyang219/TrafficMonitor](https://github.com/zhongyang219/TrafficMonitor) - 这是一个用于显示当前网速、CPU及内存利用率的桌面悬浮窗软件，并支持任务栏显示，支持更换皮肤。 (1 month ago)
