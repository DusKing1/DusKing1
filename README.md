...
- [BossHobby/QUICKSILVER](https://github.com/BossHobby/QUICKSILVER) ([v0.10.0-dev](https://github.com/BossHobby/QUICKSILVER/releases/tag/v0.10.0-dev), 1 month ago) - Flight Controller Firmware
- [bird-sanctuary/bluejay](https://github.com/bird-sanctuary/bluejay) ([v0.20.0](https://github.com/bird-sanctuary/bluejay/releases/tag/v0.20.0), 1 month ago) - :bird: Digital ESC firmware for controlling brushless motors in multirotors
...
- [RayWangQvQ/BiliBiliToolPro](https://github.com/RayWangQvQ/BiliBiliToolPro) - B 站（bilibili）自动任务工具，支持docker、青龙、k8s等多种部署方式。敏感肌也能用。 (4 weeks ago)
