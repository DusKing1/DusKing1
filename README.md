...
- [gyroflow/gyroflow](https://github.com/gyroflow/gyroflow) ([v1.0.0-rc1](https://github.com/gyroflow/gyroflow/releases/tag/v1.0.0-rc1), 2 days ago) - Video stabilization using gyroscope data
- [betaflight/betaflight-configurator](https://github.com/betaflight/betaflight-configurator) ([10.8.0-RC3](https://github.com/betaflight/betaflight-configurator/releases/tag/10.8.0-RC3), 5 days ago) - Cross platform configuration tool for the Betaflight firmware
- [betaflight/betaflight](https://github.com/betaflight/betaflight) ([4.3.0-RC3](https://github.com/betaflight/betaflight/releases/tag/4.3.0-RC3), 5 days ago) - Open Source Flight Controller Firmware
...
- [Add link for DIY hardware design](https://github.com/gyroflow/flowshutter/pull/3) on [gyroflow/flowshutter](https://github.com/gyroflow/flowshutter) (today)
